...
export function MagneticText({ 
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-5xl font-bold tracking-tighter tracking-wide", baseTextColor, textClassName)}>{text}</span>

      <div
        ref={circleRef}
        className={cn("absolute top-0 left-0 pointer-events-none rounded-full overflow-hidden", circleColor)}
        style={{
      ...
      >
        ...
        >
          <span className={cn("text-5xl font-bold tracking-tighter whitespace-nowrap tracking-wide", hoverTextColor, textClassName)}>
            {hoverText}
          </span>
        </div>
      </div>
